...
var ChromePlugin = (function (_super) {
    ...
    function ChromePlugin() {
        ...
        _this.iconPath = 'atom://atom-bugs-chrome/icons/chrome.svg';
    ...
    ChromePlugin.prototype.didRun = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var options, projectPath, contextPath, defaultMappings, socketUrl;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        contextPath = path_1.join(projectPath, options.basePath);
                        ...
                        Object
                            ...
                            _this.debugger.addMapping(origin, path_1.normalize(path_1.join(projectPath, '/', defaultMappings[origin], '/')));
                        });
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.setCurrentBreakpoints()];
                    case 4:
                        _a.sent();
                        this.enableConsole();
                        return [4 /*yield*/, this.debugger.domains.Page.reload()];
                    case 5:
                        _a.sent();
