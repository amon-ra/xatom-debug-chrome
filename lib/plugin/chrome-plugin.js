            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        projectPath_1 = lodash_1.trimEnd(this.pluginClient.getPath(), chrome_options_1.trimPathChars);
                        contextPath = path_1.join(projectPath_1, lodash_1.trimEnd(options.basePath, chrome_options_1.trimPathChars));
                        this.debugger.basePath = projectPath_1;
                        this.debugger.serverUrl = lodash_1.trimEnd(options.serverUrl, chrome_options_1.trimPathChars);
