...
var ChromePlugin = (function (_super) {
    ...
    ChromePlugin.prototype.didLoad = function () {
        this.debugger.domains.Page.reload();
    };
    ChromePlugin.prototype.didRun = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var options, projectPath, contextPath, socketUrl;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        Object
                            ...
                            _this.debugger.mappingPaths[origin] = path_1.join(projectPath, '/', options.mappingPaths[origin]);
                        });
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.debugger.domains.Page.navigate({
